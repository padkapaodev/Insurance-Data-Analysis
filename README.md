...
3. **Dashboard Visualization:** Developed an interactive data dashboard (`Insurance Data Dashboard.png`) providing a high-level executive summary of the findings.
